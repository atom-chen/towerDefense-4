...
export default class Leader extends Actor {
    ...
    onEnable() {
        ...
        let cur_tank :string = "tank_" + udb.curArmsId;
        this.players[udb.curArmsId-1].active =true;
        this._player = this.players[udb.curArmsId-1].getComponent(cur_tank);
    ...
    init() {
        ...
        let cutSpeed:number = MixedUtils.calcAttr(gunCfg.value, gunCfg.upValue,weaponData.speed , gunCfg.maxLevel) / 10000;
