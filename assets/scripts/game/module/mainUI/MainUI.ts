...
export class MainUI extends Mod {
    ...
    start(){
        ...
        this.node.setPosition(-visibleSize.width/2,-visibleSize.height/2);
    }
    ...
    onLevelBtnClick(event: cc.Event.EventTouch, customEventData: number){
        cc.log("go to "+customEventData+" level");
    }
    /** GM功能按钮点击 */
